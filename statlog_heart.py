...
#导入数据
data = pd.read_table("data/Statlog Heart/heart.dat", header=None, delimiter=" ")
...
np.savetxt('result/statlog_heart_fitness.csv', fitness.T, fmt='%.4f', delimiter=',')
np.savetxt('result/statlog_heart_error.csv', error.T, fmt='%.4f', delimiter=',')
np.savetxt('result/statlog_heart_num.csv', num.T, fmt='%.4f', delimiter=',')