...
#导入数据
data = pd.read_table("data/Zoo/zoo.data", header=None, delimiter=",")
...
np.savetxt('result/zoo_fitness.csv', fitness.T, fmt='%.4f', delimiter=',')
np.savetxt('result/zoo_error.csv', error.T, fmt='%.4f', delimiter=',')
np.savetxt('result/zoo_num.csv', num.T, fmt='%.4f', delimiter=',')